...
<body>
    ...
    <div class="wrapper">
        ...
        <main class="page-content">
            ...
            ?>
                                <select class="form-select" name="empNam" id="">
            ...
            $rowcount=mysqli_num_rows($query);
            ?>
                                <select class="form-select" name="salaryTyp" id="">
                ...
                ?>
                                ...
                                <input type="number" name="basicSalary" id="" class="form-control mt-3" placeholder="Basic Salary">

                                <input type="number" name="medical" id="" class="form-control mt-3" placeholder="Medical">

                                <input type="number" name="house" id="" class="form-control mt-3" placeholder="House Rent">

                                <input type="number" name="food" id="" class="form-control mt-3" placeholder="Food">


                                <input type="number" name="provi" id="" class="form-control mt-3" placeholder="Provident Fund">
